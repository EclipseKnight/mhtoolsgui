...
public class RebuildPluginA extends HelperEnc implements Encoder {
        ...
        try {
            ...
            for (int i = 0; i < filenames.size() - 1; i++) {
                ...
                try {
                    ...
                    Window.writeToConsole(filenames.get(i)
            ...
            Window.writeToConsole("Reading " + filenames.lastElement());
            ...
            if (out.getFilePointer() > size - enddataSize) {
                ...
                Window.writeToConsole("Perfect size of file :O");
            }
    ...
    public void createStringTable(String directory, String in,
        ...
        Window.writeToConsole("Reading " + directory + "/" + in);
